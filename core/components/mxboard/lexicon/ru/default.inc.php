...
$_lang['mxboard_err_project_denied'] = 'Нельзя создавать задачи в этом проекте: вы не состоите в отделе, которому он принадлежит.';
$_lang['mxboard_err_parent_final'] = 'Нельзя создать подзадачу у задачи в финальной стадии.';
$_lang['mxboard_err_task_closed'] = 'Задача закрыта: изменения запрещены. Разрешена только смена стадии — верните карточку из финальной стадии, чтобы править её.';
...
$_lang['mxboard_err_overview_denied'] = 'Обзор задач отдела доступен только его руководителю.';
...
$_lang['mxboard_err_priority_not_found'] = 'Приоритет не найден.';
$_lang['mxboard_err_priority_name_required'] = 'Укажите название приоритета.';
$_lang['mxboard_err_priority_value_invalid'] = 'Числовое значение приоритета — целое неотрицательное число.';
$_lang['mxboard_err_priority_value_exists'] = 'Приоритет с таким числовым значением уже есть.';
$_lang['mxboard_err_priority_name_exists'] = 'Приоритет с таким названием уже есть.';
$_lang['mxboard_err_priority_last'] = 'Нельзя удалить последний приоритет — справочник не может быть пустым.';
$_lang['mxboard_err_priority_unknown'] = 'Такого приоритета нет в справочнике.';
...
$_lang['mxboard_ui_search_clear'] = 'Очистить поиск';
...
// Обзор задач отдела (вкладка руководителя): таблица всех проектов отдела с фильтрами.
$_lang['mxboard_ui_overview'] = 'Обзор';
$_lang['mxboard_ui_overview_title'] = 'Задачи отдела';
$_lang['mxboard_ui_overview_no_departments'] = 'Вы не руководите ни одним отделом — обзор пуст.';
$_lang['mxboard_ui_overview_empty'] = 'Под выбранные фильтры не подходит ни одна задача.';
$_lang['mxboard_ui_overview_empty_department'] = 'В проектах отдела ещё нет задач. Создайте первую на вкладке «Доска».';
$_lang['mxboard_ui_overview_count'] = 'Задач: [[+total]]';
$_lang['mxboard_ui_overview_back'] = 'К списку задач';
$_lang['mxboard_ui_overview_col_num'] = '№';
$_lang['mxboard_ui_overview_col_title'] = 'Задача';
$_lang['mxboard_ui_overview_col_stage'] = 'Стадия';
$_lang['mxboard_ui_overview_col_author'] = 'Автор';
$_lang['mxboard_ui_overview_col_assignee'] = 'Исполнитель';
$_lang['mxboard_ui_overview_col_deadline'] = 'Дедлайн';
$_lang['mxboard_ui_overview_col_time'] = 'План / факт';
$_lang['mxboard_ui_overview_col_type'] = 'Тип';
$_lang['mxboard_ui_overview_filter_priority'] = 'Приоритет';
$_lang['mxboard_ui_overview_filter_project'] = 'Проект';
$_lang['mxboard_ui_overview_filter_author'] = 'Автор';
$_lang['mxboard_ui_overview_filter_assignee'] = 'Исполнитель';
$_lang['mxboard_ui_overview_filter_stage'] = 'Стадия';
$_lang['mxboard_ui_overview_filter_any'] = 'Любой';
$_lang['mxboard_ui_overview_selected'] = 'выбрано: [[+count]]';
$_lang['mxboard_ui_overview_priority_hint'] = 'Приоритет: [[+name]]';
$_lang['mxboard_ui_overview_fact_running'] = 'Идёт';
$_lang['mxboard_ui_overview_no_deadline'] = 'без срока';
$_lang['mxboard_ui_overview_no_plan'] = '—';
...
$_lang['mxboard_ui_subtask_other_project'] = 'Подзадача уйдёт на доску другого проекта. Тип и исполнитель — из его отдела.';
$_lang['mxboard_ui_other_project'] = 'Другой проект';
$_lang['mxboard_ui_parent_in_project'] = 'Родитель в проекте';
$_lang['mxboard_ui_subtask_in_project'] = 'Подзадача в проекте';
$_lang['mxboard_ui_task_closed'] = 'Задача закрыта — изменения недоступны';
$_lang['mxboard_ui_task_closed_hint'] = 'Задача в финальной стадии: правки, комментарии и вложения недоступны. Верните её из финальной стадии, чтобы продолжить работу.';
...
$_lang['mxboard_ui_resolve'] = 'Решить';
$_lang['mxboard_ui_resolve_title'] = 'Разрешение оспаривания';
...
$_lang['mxboard_ui_reason_max_hint'] = 'Максимум 1000 символов, лишнее будет обрезано';
$_lang['mxboard_ui_reason_empty'] = 'Причина не указана';
...
$_lang['mxboard_act_subtask_delete'] = 'удалена подзадача';
$_lang['mxboard_act_delete'] = 'удалена';
...
$_lang['mxboard_msg_num_copied'] = 'Номер скопирован';
$_lang['mxboard_msg_copy_failed'] = 'Не удалось скопировать';
...
$_lang['mxboard_ui_copy_num'] = 'Скопировать номер';
$_lang['mxboard_ui_open_task'] = 'Открыть задачу';
...
$_lang['mxboard_notify_delete'] = 'Задача удалена';
...
$_lang['mxboard_ui_struct_priorities'] = 'Приоритеты';
$_lang['mxboard_ui_struct_priorities_hint'] = 'Глобальный справочник приоритетов — один на всю систему, без привязки к проекту. Числовое значение и название уникальны; последний приоритет удалить нельзя.';
$_lang['mxboard_ui_struct_new_priority'] = 'Новый приоритет';
$_lang['mxboard_ui_struct_priority_value'] = 'Значение';
$_lang['mxboard_ui_struct_priority_value_hint'] = 'Целое число: больше — важнее. Пишется в приоритет карточки.';
$_lang['mxboard_ui_struct_confirm_remove_priority'] = 'Удалить приоритет «[[+name]]»?';
